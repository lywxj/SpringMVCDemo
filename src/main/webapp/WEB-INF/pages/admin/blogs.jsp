...
<div class="container">
    ...
    <hr/>
    <a href="/" type="button" class="btn btn-sm btn-success">首页</a>
    <a href="/admin/users" type="button" class="btn btn-sm btn-success">用户</a>
    <a href="/admin/blogs" type="button" class="btn btn-sm btn-success">博客</a>
